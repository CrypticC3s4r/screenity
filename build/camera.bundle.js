 ...
 * =============================================================================
 */
const Na=n.n(Ea)()||Ea;function Ta(e){return Na.fromString(e,!0,16)}const _a=Ta("c3a5c85c97cb3127"),Ia=Ta("b492b66fbe98f273"),Aa=Ta("9ae16a3b2f90404f");function Ma(e){return e.xor(e.shru(47))}function Oa(e,t,n){const r=e.slice(t,t+n);return Na.fromBytes(Array.from(r),!0,!0)}function Da(e,t){return Oa(e,t,8)}function Ca(e,t){return Oa(e,t,4)}function $a(e,t){return 0===t?e:e.shru(t).or(e.shl(64-t))}function Ra(e,t,n=Ta("9ddfea08eb382d69")){let r=e.xor(t).mul(n);r=r.xor(r.shru(47));let a=t.xor(r).mul(n);return a=a.xor(a.shru(47)),a=a.mul(n),a}function Fa(e,t,n,r){return function(e,t,n,r,a,o){a=a.add(e),o=$a(o.add(a).add(r),21);const s=a;return a=(a=a.add(t)).add(n),o=o.add($a(a,44)),[a.add(r),o.add(s)]}(Da(e,t),Da(e,t+8),Da(e,t+16),Da(e,t+24),n,r)}function La(e,t=e.length){const n=Na.fromNumber(81,!0);if(t<=32)return t<=16?function(e,t=e.length){if(t>=8){const n=Aa.add(2*t),r=Da(e,0).add(Aa),a=Da(e,t-8);return Ra($a(a,37).mul(n).add(r),$a(r,25).add(a).mul(n),n)}if(t>=4){const n=Aa.add(2*t);return Ra(Ca(e,0).shl(3).add(t),Ca(e,t-4),n)}if(t>0){const n=e[0]+(e[t>>1]<<8),r=t+(e[t-1]<<2);return Ma(Aa.mul(n).xor(_a.mul(r))).mul(Aa)}return Aa}(e,t):function(e,t=e.length){const n=Aa.add(2*t),r=Da(e,0).mul(Ia),a=Da(e,8),o=Da(e,t-8).mul(n),s=Da(e,t-16).mul(Aa);return Ra($a(r.add(a),43).add($a(o,30)).add(s),r.add($a(a.add(Aa),18)).add(o),n)}(e,t);if(t<=64)return function(e,t=e.length){const n=Aa.add(2*t),r=Da(e,0).mul(Aa),a=Da(e,8),o=Da(e,t-8).mul(n),s=Da(e,t-16).mul(Aa),i=$a(r.add(a),43).add($a(o,30)).add(s),u=Ra(i,r.add($a(a.add(Aa),18)).add(o),n),l=Da(e,16).mul(n),c=Da(e,24),p=i.add(Da(e,t-32)).mul(n),d=u.add(Da(e,t-24)).mul(n);return Ra($a(l.add(c),43).add($a(p,30)).add(d),l.add($a(c.add(r),18)).add(p),n)}(e,t);let r=n,a=n.mul(Ia).add(113),o=Ma(a.mul(Aa).add(113)).mul(Aa),s=[Na.UZERO,Na.UZERO],i=[Na.UZERO,Na.UZERO];r=r.mul(Aa).add(Da(e,0));let u=0;const l=64*(t-1>>6),c=l+(t-1&63)-63;do{r=$a(r.add(a).add(s[0]).add(Da(e,u+8)),37).mul(Ia),a=$a(a.add(s[1]).add(Da(e,u+48)),42).mul(Ia),r=r.xor(i[1]),a=a.add(s[0]).add(Da(e,u+40)),o=$a(o.add(i[0]),33).mul(Ia),s=Fa(e,u,s[1].mul(Ia),r.add(i[0])),i=Fa(e,u+32,o.add(i[1]),a.add(Da(e,u+16))),[o,r]=[r,o],u+=64}while(u!==l);const p=Ia.add(o.and(255).shl(1));return u=c,i[0]=i[0].add(t-1&63),s[0]=s[0].add(i[0]),i[0]=i[0].add(s[0]),r=$a(r.add(a).add(s[0]).add(Da(e,u+8)),37).mul(p),a=$a(a.add(s[1]).add(Da(e,u+48)),42).mul(p),r=r.xor(i[1].mul(9)),a=a.add(s[0].mul(9).add(Da(e,u+40))),o=$a(o.add(i[0]),33).mul(p),s=Fa(e,u,s[1].mul(p),r.add(i[0])),i=Fa(e,u+32,o.add(i[1]),a.add(Da(e,u+16))),[o,r]=[r,o],Ra(Ra(s[0],i[0],p).add(Ma(a).mul(_a)).add(o),Ra(s[1],i[1],p).add(r),p)}
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function qo(e,t,n){return Ho(e,t,Lo(e,n),n)}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const Rs="://";class Fs{constructor(){this.managers={}}static getInstance(){return null==Fs.instance&&(Fs.instance=new Fs),Fs.instance}static registerManager(e,t){X(null!=e,(()=>"scheme must not be undefined or null.")),e.endsWith(Rs)&&(e=e.slice(0,e.indexOf(Rs))),X(e.length>0,(()=>"scheme must not be an empty string."));const n=Fs.getInstance();X(null==n.managers[e],(()=>`A model store manager is already registered for scheme '${e}'.`)),n.managers[e]=t}static getManager(e){const t=Fs.getInstance().managers[e];if(null==t)throw new Error(`Cannot find model manager for scheme '${e}'`);return t}static getSchemes(){return Object.keys(Fs.getInstance().managers)}}function Ls(e){if(-1===e.indexOf(Rs))throw new Error(`The url string provided does not contain a scheme. Supported schemes are: ${Fs.getSchemes().join(",")}`);return{scheme:e.split(Rs)[0],path:e.split(Rs)[1]}}async function Ps(e,t,n=!1){X(e!==t,(()=>`Old path and new path are the same: '${e}'`));const r=ls.getLoadHandlers(e);X(r.length>0,(()=>`Copying failed because no load handler is found for source URL ${e}.`)),X(r.length<2,(()=>`Copying failed because more than one (${r.length}) load handlers for source URL ${e}.`));const a=r[0],o=ls.getSaveHandlers(t);X(o.length>0,(()=>`Copying failed because no save handler is found for destination URL ${t}.`)),X(o.length<2,(()=>`Copying failed because more than one (${r.length}) save handlers for destination URL ${t}.`));const s=o[0],i=Ls(e).scheme,u=Ls(e).path,l=i===Ls(e).scheme,c=await a.load();n&&l&&await Fs.getManager(i).removeModel(u);const p=await s.save(c);return n&&!l&&await Fs.getManager(i).removeModel(u),p.modelArtifactsInfo}async function zs(){const e=Fs.getSchemes(),t={};for(const n of e){const e=await Fs.getManager(n).listModels();for(const r in e){t[n+Rs+r]=e[r]}}return t}async function Bs(e){const t=Ls(e);return Fs.getManager(t.scheme).removeModel(t.path)}async function Vs(e,t){return Ps(e,t,!1)}async function Us(e,t){return Ps(e,t,!0)}
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:Bo(e,"x","sqrt","float32")};return Mo.runKernel(Ar,t)}});const Si=jo({square_:
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const Ci=new Map,$i=new Map;class Ri{getClassName(){return this.constructor.className}static fromConfig(e,t){return new e(t)}}class Fi{constructor(){this.classNameMap={}}static getMap(){return null==Fi.instance&&(Fi.instance=new Fi),Fi.instance}static register(e){Fi.getMap().classNameMap[e.className]=[e,e.fromConfig]}}function Li(e,t,n){X(null!=e.className,(()=>"Class being registered does not have the static className property defined.")),X("string"==typeof e.className,(()=>"className is required to be a string, but got type "+typeof e.className)),X(e.className.length>0,(()=>"Class being registered has an empty-string as its className, which is disallowed.")),void 0===t&&(t="Custom"),void 0===n&&(n=e.className);const r=t+">"+n;return Fi.register(e),Ci.set(r,e),$i.set(e,r),e}function Pi(e){return $i.has(e)?$i.get(e):e.className}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Au(e,t,n){if(J(e),null!=t&&3!==t.length)throw new Error("tensor3d() requires shape to have three numbers");const r=Lo(e,n);if(3!==r.length&&1!==r.length)throw new Error("tensor3d() requires values to be number[][][] or flat/TypedArray");if(1===r.length&&null==t)throw new Error("tensor3d() requires shape to be provided when `values` are a flat array");return Ho(e,t,r,n)}
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=null,n=!1){const r={x:Bo(e,"x","all","bool")},a={axis:t,keepDims:n};return Mo.runKernel(Ye,r,a)}});const Il=jo({any_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=null,n=!1){const r={x:Bo(e,"x","any","bool")},a={axis:t,keepDims:n};return Mo.runKernel(Xe,r,a)}});const Al=jo({argMax_:
/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:Bo(e,"x","cos","float32")};return Mo.runKernel(_t,t)}});const Ic=jo({cosh_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:Bo(e,"x","cosh","float32")};return Mo.runKernel(It,t)}});const Ac=jo({cumprod_:
/**
 * @license
 ...
 * =============================================================================
 */
function(e,t=0,n=!1,r=!1){const a={x:Bo(e,"x","cumprod")},o={axis:t,exclusive:n,reverse:r};return Mo.runKernel(At,a,o)}});const Mc=jo({cumsum_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:Bo(e,"x","diag")};return Mo.runKernel(Lt,t)}});const Rc=jo({dilation2d_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=Bo(e,"a","equal","string_or_numeric"),r=Bo(t,"b","equal","string_or_numeric");[n,r]=xo(n,r),Qi(n.shape,r.shape);const a={a:n,b:r};return Mo.runKernel(Gt,a)}});const Lc=jo({where_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n){const r=Bo(t,"a","where"),a=Bo(n,"b","where"),o=Bo(e,"condition","where","bool"),s=Qi(Qi(o.shape,r.shape),a.shape),i={condition:fc(o,s),t:fc(r,s),e:fc(a,s)};return Mo.runKernel(xr,i)}});const Pc=jo({divNoNan_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=Bo(e,"a","div"),r=Bo(t,"b","div");[n,r]=xo(n,r);const a=wi(n,r),o=Ei(a),s=Fc(r,o);return Lc(s,o,a)}});const zc=jo({dot_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=null,n=!1){const r={x:Bo(e,"x","max")},a={reductionIndices:t,keepDims:n};return Mo.runKernel(An,r,a)}});const Jc=jo({min_:
/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=null,n=!1){const r={x:Bo(e,"x","min")},a={axis:t,keepDims:n};return Mo.runKernel(Ln,r,a)}});const ep=jo({sum_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:Bo(e,"x","softplus")};return Mo.runKernel(Ir,t)}});const Ep=jo({logSigmoid_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n=Bo(e,"a","logicalAnd","bool"),r=Bo(t,"b","logicalAnd","bool");Qi(n.shape,r.shape);const a={a:n,b:r};return Mo.runKernel(wn,a)}});const Ip=jo({logicalNot_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:Bo(e,"x","logicalNot","bool")};return Mo.runKernel(xn,t)}});const Ap=jo({logicalOr_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n=Bo(e,"a","logicalXor","bool"),r=Bo(t,"b","logicalXor","bool");return Qi(n.shape,r.shape),_p(Ap(e,t),Ip(_p(e,t)))}}),Op=2147483648;const Dp=jo({searchSorted_:function(e,t,n="left"){const r=Bo(e,"sortedSequence","searchSorted"),a=Bo(t,"values","searchSorted"),o=r.shape[r.shape.length-1],s=a.shape[a.shape.length-1],i=Xl(r,[-1,o]),u=Xl(a,[-1,s]);if(i.rank<2)throw new Error("Sorted input argument must be at least 2-dimensional");if(i.shape[0]!==u.shape[0])throw new Error("Leading dimension of 'sortedSequence' and 'values' must match.");if(ee(u.shape)>=Op)throw new Error("values tensor size must less than 2147483648");if(i.shape[1]>=Op)throw new Error(`trailing dim_size must less than 2147483648 for int32 output type, was ${i.shape[1]}`);const l={sortedSequence:i,values:u},c={side:n};return Mo.runKernel(wr,l,c)}});
/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r,a=!1){const o={x:Bo(e,"x","maxPoolWithArgmax")},s={filterSize:t,strides:n,pad:r,includeBatchInIndex:a},i=Mo.runKernel(Rn,o,s);return{result:i[0],indexes:i[1]}}});const Lp=jo({mean_:
/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Pp(e,t="float32"){if(Ce(e),"complex64"===t){const t=Pp(e,"float32"),n=Pp(e,"float32");return Wo(t,n)}const n=Oe(ee(e),t);return Mo.makeTensor(n,e,t)}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function zp(e,t="float32"){if(Ce(e),"complex64"===t){const t=zp(e,"float32"),n=Pp(e,"float32");return Wo(t,n)}const n=Me(ee(e),t);return Mo.makeTensor(n,e,t)}
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=Bo(e,"a","minimum"),r=Bo(t,"b","minimum");[n,r]=xo(n,r),"bool"===n.dtype&&(n=Ks(n,"int32"),r=Ks(r,"int32")),Qi(n.shape,r.shape);const a={a:n,b:r};return Mo.runKernel(Pn,a)}});const Up=jo({mirrorPad_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:Bo(e,"x","round")};return Mo.runKernel(gr,t)}});const Id=jo({rsqrt_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:Bo(e,"x","rsqrt","float32")};return Mo.runKernel(yr,t)}});const Ad=jo({selu_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n){const r=Bo(e,"x","slice2d");return X(2===r.rank,(()=>`slice2d expects a rank-2 tensor, but got a rank-${r.rank} tensor`)),nc(r,t,n)}});const Ld=jo({slice3d_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n){const r=Bo(e,"x","slice3d");return X(3===r.rank,(()=>`slice3d expects a rank-3 tensor, but got a rank-${r.rank} tensor`)),nc(r,t,n)}});const Pd=jo({slice4d_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Xd(e,t){J(e);const n=Lo(e,t);if(1!==n.length)throw new Error("tensor1d() requires values to be a flat/TypedArray");return Ho(e,null,n,t)}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Zd(e,t,n){if(J(e),null!=t&&2!==t.length)throw new Error("tensor2d() requires shape to have two numbers");const r=Lo(e,n);if(2!==r.length&&1!==r.length)throw new Error("tensor2d() requires values to be number[][] or flat/TypedArray");if(1===r.length&&null==t)throw new Error("tensor2d() requires shape to be provided when `values` are a flat/TypedArray");return Ho(e,t,r,n)}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function ef(e,t,n){if(J(e),null!=t&&5!==t.length)throw new Error("tensor5d() requires shape to have five numbers");const r=Lo(e,n);if(5!==r.length&&1!==r.length)throw new Error("tensor5d() requires values to be number[][][][][] or flat/TypedArray");if(1===r.length&&null==t)throw new Error("tensor5d() requires shape to be provided when `values` are a flat array");return Ho(e,t,r,n)}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r,a,o=[1,1],s){let i=e;3===e.rank&&(i=Xl(e,[1,e.shape[0],e.shape[1],e.shape[2]]));let u=t;3===u.rank&&(u=Xl(t,[1,t.shape[0],t.shape[1],t.shape[2]]));const l={x:i,dy:u},c={strides:r,pad:a,dimRoundingMode:s,dilations:o,filterShape:n};return Mo.runKernel(Rt,l,c)}});const Af=jo({depthwiseConv2dNativeBackpropInput_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t=Bo(e,"image","flipLeftRight","float32");X(4===t.rank,(()=>`Error in flipLeftRight: image must be rank 4,but got rank ${t.rank}.`));const n={image:t};return Mo.runKernel(Jt,n,{})}});const Pf=jo({grayscaleToRGB_:
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n){const r=Bo(e,"a","bandPart");X(r.rank>=2,(()=>`bandPart(): Rank must be at least 2, got ${r.rank}.`));const a=r.shape,[o,s]=r.shape.slice(-2);let i,u;"number"==typeof t?(X(t%1==0,(()=>`bandPart(): numLower must be an integer, got ${t}.`)),X(t<=o,(()=>`bandPart(): numLower (${t}) must not be greater than the number of rows (${o}).`)),i=Bo(t<0?o:t,"numLower","bandPart")):(X("int32"===t.dtype,(()=>"bandPart(): numLower's dtype must be an int32.")),i=Lc(yp(t,0),o,Vp(t,o))),"number"==typeof n?(X(n%1==0,(()=>`bandPart(): numUpper must be an integer, got ${n}.`)),X(n<=s,(()=>`bandPart(): numUpper (${n}) must not be greater than the number of columns (${s}).`)),u=Bo(n<0?s:n,"numUpper","bandPart")):(X("int32"===n.dtype,(()=>"bandPart(): numUpper's dtype must be an int32.")),u=Lc(yp(n,0),s,Vp(n,s)));const l=Xl(bd(0,o,1,"int32"),[-1,1]),c=bd(0,s,1,"int32"),p=Wi(l,c),d=_p(bp(p,i),dp(p,Nu(u))),f=Pp([o,s],r.dtype);return Xl(Gd(uf(Xl(r,[-1,o,s])).map((e=>Lc(d,e,f)))),a)}});const uh=jo({gramSchmidt_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
var ph;!function(e){e[e.NONE=0]="NONE",e[e.MEAN=1]="MEAN",e[e.SUM=2]="SUM",e[e.SUM_BY_NONZERO_WEIGHTS=3]="SUM_BY_NONZERO_WEIGHTS"}(ph||(ph={}));const dh=jo({computeWeightedLoss_:function(e,t,n=ph.SUM_BY_NONZERO_WEIGHTS){const r=Bo(e,"losses","computeWeightedLoss");let a=null;null!=t&&(a=Bo(t,"weights","computeWeightedLoss"));const o=null==a?r:xi(r,a);if(n===ph.NONE)return o;if(n===ph.SUM)return ep(o);if(n===ph.MEAN){if(null==a)return Lp(o);{const e=r.size/a.size,t=wi(ep(o),ep(a));return e>1?wi(t,Di(e)):t}}if(n===ph.SUM_BY_NONZERO_WEIGHTS){if(null==a)return wi(ep(o),Di(r.size));{const e=xi(a,zp(r.shape)),t=Ks(ep(Gp(e,Di(0))),"float32");return wi(ep(o),t)}}throw Error(`Unknown reduction: ${n}`)}});const fh=jo({absoluteDifference_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
var Ph;function zh(e,t,n){let r=new Array;if(null==n&&null==t)return r;if(null==t)for(;r.length<e+n.length;)r.push(-1);else r=t.slice();if(null==n)return r;if(e+n.length!==r.length)throw new Error(`rt input.shape and shape=${t} are incompatible: rt input.rank = ${e+n.length}, but shape.rank = ${r.length}`);for(let a=1;a<n.length;++a){const o=n[a],s=r[r.length-n.length+a],i=r[s];if(o>=0)if(i>=0){if(i!==o)throw new Error(`rt input.shape and shape=${t} are incompatible: rt input.shape[${a+e}] = ${o} but shape[${a+e}] = ${i}`)}else r[s]=o}return r}function Bh(e){const t={FIRST_DIM_SIZE:Ph.FIRST_DIM_SIZE,VALUE_ROWIDS:Ph.VALUE_ROWIDS,ROW_LENGTHS:Ph.ROW_LENGTHS,ROW_SPLITS:Ph.ROW_SPLITS,ROW_LIMITS:Ph.ROW_LIMITS,ROW_STARTS:Ph.ROW_STARTS},n=[];for(const r of e){if(!(r in t))break;n.push(t[r])}return n}function Vh(e){return 0===e.length?0:e[0]===Ph.FIRST_DIM_SIZE?e.length-1:e.length}function Uh(e,t){if(null==e||null==t)return;const n=e.length,r=t.length;if(n>=r)throw new Error(`defaultValue.shape=${e} and ragged tensor flatValues.shape=${t}, are incompatible: defaultValue.rank = ${n} must be less than ragged tensor input flatValues.rank = ${r})`);for(let a=0;a<Math.min(n,r-1);++a){const n=e[a],r=t[a+1];if(n>=0&&r>=0&&1!==n&&n!==r)throw new Error(`defaultValue.shape=${e}, and ragged tensor input flatValues.shape=${t} are incompatible: defaultValue.shape[${a-e.length}] = ${n} but ragged tensor input.flatValues.shape[${a-e.length}] = ${r}`)}}!function(e){e[e.FIRST_DIM_SIZE=0]="FIRST_DIM_SIZE",e[e.VALUE_ROWIDS=1]="VALUE_ROWIDS",e[e.ROW_LENGTHS=2]="ROW_LENGTHS",e[e.ROW_SPLITS=3]="ROW_SPLITS",e[e.ROW_LIMITS=4]="ROW_LIMITS",e[e.ROW_STARTS=5]="ROW_STARTS"}(Ph||(Ph={}));
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
!function(){for(const e of tu)Li(e)}();
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
